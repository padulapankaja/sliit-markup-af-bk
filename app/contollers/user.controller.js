...
exports.signin = async (req, res) => {
    ...
    if (user_details == null) {
        ...
        if (!is_equal) {
            ...
            const token = jwt.sign({ email: user_details.email, fname: user_details.fname }, process.env.JWT_SCREAT);
...
exports.validate = (method) => {
    switch (method) {
        case "CREATE_USER": {
            return [
                body('fname', "name doesn't exists").exists(),
                body('lname', "invalid email").exists(),
